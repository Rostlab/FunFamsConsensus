...
def main():
    ...
    for uniprot_id in valid_ids:
        ...
        alignment_stats_file = os.path.join(args.evc_info_dir, uniprot_id + '_alignment_statistics.csv')
        di_file = os.path.join(args.evc_info_dir, uniprot_id + ".di")
        outcfg_file = os.path.join(args.evc_info_dir, uniprot_id + "_final.outcfg")
